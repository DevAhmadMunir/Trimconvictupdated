              ...
              child: Stack(
                children: [
                  ...
                  const SizedBox(
                    ...
                    width: 120,
                    child: TRoundedImage(
                      imageUrl: TImage.eastern4, applyImageRadius: true),
                  ),
                ...
                child: Column(
                  ...
                  children: [
                     const Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        TProductTitleText(title: '2 piece suite', smallSize: true),
                        SizedBox(height: TSizes.spaceBtwItems / 2),
                        TBrandTitleWithVerifiedIcon(title: 'Eastern'),
                      ],
                    ),
                    ...
                    Row(
                      ...
                      children: [
                        //------------pricing---------
                        const Flexible(child: TProductPriceText(price: '2499')),
                        //------------Add to cart------
                        Container(
